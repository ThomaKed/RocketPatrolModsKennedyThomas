class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.ship04 = new Spaceship(this, game.config.width + borderUISize*13, borderUISize*8, 'spaceship', 0, -100, game.settings.spaceshipSpeed*0.5).setOrigin(0,0);
